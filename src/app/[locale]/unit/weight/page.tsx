...
export default function WeightConverter() {
  const t = useTranslations('unit.weight');
  const tc = useTranslations('common');

  const units = [
    { code: 'kg', name: t('units.kilogram'), factor: 1 },
    { code: 'g', name: t('units.gram'), factor: 0.001 },
    { code: 'mg', name: t('units.milligram'), factor: 0.000001 },
    { code: 'lb', name: t('units.pound'), factor: 0.453592 },
    { code: 'oz', name: t('units.ounce'), factor: 0.0283495 },
    { code: 'st', name: t('units.stone'), factor: 6.35029 },
    { code: 't', name: t('units.metricTon'), factor: 1000 },
  ];
